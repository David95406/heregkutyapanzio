    ...
    <div class="flex flex-col tablet:flex-row w-full manrope-normal">
        <section class="flex flex-col w-full bg-light-blue @h-1/2">
            ...
            <div class="flex flex-col flex-grow">
                <h1 class="p-3 manrope-bold text-textBlue text-5xl tracking-widest">Foglalj időpontot egyszerűen</h1>
                <h3 class="px-3.5 text-textBlue">Válaszd ki a számodra megfelelő napot, majd add meg adataidat, és küldd
