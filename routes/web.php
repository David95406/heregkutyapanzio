...
Route::get('foglalas/verify/{token}', [BookingController::class, 'verify'])
    ->name('booking.verify')
    ->middleware('signed');
...
Route::middleware('auth:admin')->prefix('admin')->group(function () {
    ...
    // Removed double '/admin' prefix from these routes
    Route::put('settings/about1', [SettingsController::class, 'updateAbout1'])->name('settings.update-about1');
    Route::put('settings/about2', [SettingsController::class, 'updateAbout2'])->name('settings.update-about2');
